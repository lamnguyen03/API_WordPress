<?php
if ( ! class_exists( 'News_Hub_Slider_Widget' ) ) {
	/**
	 * Adds News Hub Slider Widget.
	 */
	class News_Hub_Slider_Widget extends WP_Widget {
		...
		public function __construct() {
			$slider_widget = array(
				...
				'description' => __( 'Retrive Slider Widgets', 'news-hub' ),
			);
			parent::__construct(
				'news_hub_slider_widget',
				__( 'News Hub: Slider Widget', 'news-hub' ),
				$slider_widget
			);
		}
