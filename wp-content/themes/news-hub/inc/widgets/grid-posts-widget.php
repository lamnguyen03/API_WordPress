<?php
if ( ! class_exists( 'News_Hub_Grid_Posts_Widget' ) ) {
	/**
	 * Adds News Hub Grid Posts Widget.
	 */
	class News_Hub_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$grid_posts_widget = array(
				...
				'description' => __( 'Retrive Grid Posts Widgets', 'news-hub' ),
			);
			parent::__construct(
				'news_hub_grid_posts_widget',
				__( 'News Hub: Grid Posts Widget', 'news-hub' ),
				$grid_posts_widget
			);
		}
