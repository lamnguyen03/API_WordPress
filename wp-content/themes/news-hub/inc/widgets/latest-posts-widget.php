<?php
if ( ! class_exists( 'News_Hub_Latest_Posts_Widget' ) ) {
	/**
	 * Adds News Hub Latest Posts Widget.
	 */
	class News_Hub_Latest_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$latest_posts_widget = array(
				...
				'description' => __( 'Retrive Latest Posts Widgets', 'news-hub' ),
			);
			parent::__construct(
				'news_hub_latest_posts_widget',
				__( 'News Hub: Latest Posts Widget', 'news-hub' ),
				$latest_posts_widget
			);
		}
