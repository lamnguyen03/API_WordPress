...
$archive_category   = get_theme_mod( 'news_hub_enable_archive_category', true );
$archive_author     = get_theme_mod( 'news_hub_enable_archive_author', true );
$archive_date       = get_theme_mod( 'news_hub_enable_archive_date', true );
$archive_comments   = get_theme_mod( 'news_hub_enable_archive_comment', true );
